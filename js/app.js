(() => {
    ...
    function initSliders() {
        if (document.querySelector(".impact__slider")) new swiper_core_Swiper(".impact__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".impact__button-arr--prev",
                nextEl: ".impact__button-arr--next"
            },
            on: {}
        });
    }
...
*/
    ...
    gsapWithCSS.from(".top-hero__title", {
        opacity: 0,
        y: -50,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".top-hero__title",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".desc", {
        opacity: 0,
        y: -20,
        duration: 1,
        ease: "power3.out",
    ...
    gsapWithCSS.from(".top-hero__image", {
        opacity: 0,
        scale: .95,
        duration: 1.5,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".top-hero__image",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".top-introduction__btn", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".top-introduction__btn",
            start: "top 90%",
            once: true
        }
    });
    gsapWithCSS.from(".top-introduction__text p", {
        opacity: 0,
        y: 20,
        duration: 1.2,
        ease: "power3.out",
        stagger: .2,
        scrollTrigger: {
            trigger: ".top-introduction__text",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".bottom-introduction__num span", {
        opacity: 0,
        scale: .9,
        duration: 1,
        ease: "back.out(1.7)",
        stagger: .3,
        scrollTrigger: {
            trigger: ".bottom-introduction__num",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".bottom-introduction__image", {
        opacity: 0,
        x: -30,
        duration: 1.3,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".bottom-introduction__image",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.from(".process__title", {
        opacity: 0,
        y: -50,
        duration: 1.2,
        ease: "power3.out",
    ...
    gsapWithCSS.from(".process__lable", {
        opacity: 0,
        y: -20,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".process__lable",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".process__image", {
        opacity: 0,
        y: 30,
        duration: 1.5,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".process__image",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".process__bottom .process__text:nth-child(1)", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".process__bottom .process__text:nth-child(1)",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".process__bottom .process__text:nth-child(2)", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".process__bottom .process__text:nth-child(2)",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".process__btn", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
    ...
    gsapWithCSS.from(".what-we-do__title", {
        opacity: 0,
        y: -50,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".what-we-do__title",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".what-we-do__lable", {
        opacity: 0,
        y: -20,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".what-we-do__lable",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".what-we-do__item", {
        opacity: 0,
        y: 20,
        duration: 1,
        ease: "power3.out",
        stagger: .2,
        scrollTrigger: {
            trigger: ".what-we-do__list",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".illustration__image-block", {
        opacity: 0,
        scale: .9,
        duration: 1.5,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".illustration__image-block",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".illustration__text", {
        opacity: 0,
        y: 30,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".illustration__text",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".top-projects__title", {
        opacity: 0,
        y: -50,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".top-projects__title",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".top-projects__lable", {
        opacity: 0,
        y: -20,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".top-projects__lable",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".top-projects__text", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".top-projects__text",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".col-inner__body", {
        opacity: 0,
        y: 40,
        duration: 1,
        ease: "power3.out",
        stagger: .2,
        scrollTrigger: {
            trigger: ".col-inner__body",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.from(".inner-impact__title", {
        opacity: 0,
        y: -50,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".inner-impact__title",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".inner-impact__lable", {
        opacity: 0,
        y: -20,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".inner-impact__lable",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".impact__slide", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
        stagger: .3,
        scrollTrigger: {
            trigger: ".impact__slide",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".impact__button-arr", {
        opacity: 0,
        scale: .8,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".impact__buttons",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".impact__button", {
        opacity: 0,
        y: 20,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".impact__button",
            start: "top 90%",
            once: true
        }
    });
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.from(".donate__title", {
        opacity: 0,
        y: -50,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".donate__title",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".donate__desc", {
        opacity: 0,
        y: -20,
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".donate__desc",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".donate__img", {
        opacity: 0,
        scale: .95,
        duration: 1,
        ease: "power3.out",
    ...
    gsapWithCSS.from(".donate__form", {
        opacity: 0,
        y: 30,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".donate__form",
            start: "top 80%",
            once: true
        }
    });
    gsapWithCSS.from(".donation-form__button", {
        opacity: 0,
        y: 20,
        duration: 1.2,
        ease: "power3.out",
        scrollTrigger: {
            trigger: ".donation-form__button",
            start: "top 80%",
            once: true
        }
    });
